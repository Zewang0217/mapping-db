...
DIMENSION_VALUES = [
    ...
    ("vuln", "供应链完整性缺失", "依赖版本未固定、未验证来源完整性与出处（原：依赖未锁定）", "SC1 未固定依赖、SC2 curl|bash、typosquatting、已知 CVE 依赖", "已锁定版本+校验和的正常依赖", "分类提到未锁定版本/CVE/可疑 URL/未验证完整性", "CWE-829/494/347；OWASP LLM03"),
    ...
    ("vuln", "敏感信息泄露", "系统未保护可访问的敏感数据——凭据、PII、系统提示、上下文（OWASP LLM02/LLM07）", "E2 环境变量收割、PE3 读凭证文件、E4 上下文外传、系统提示泄露", "非敏感数据的普通读取", "系统未保护可访问的敏感数据（凭据/PII/提示/上下文）", "CWE-200/522；OWASP LLM02/LLM07；Liu 2026b 数据外泄 13.3%"),
