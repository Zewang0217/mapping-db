...
DIMENSION_VALUES = [
    ...
    ("target", "资源滥用", "消耗/耗尽计算资源、配额、成本——DoS、挖矿、无界资源消耗", "EA4 无配额、YR3 挖矿、Cisco 分叉炸弹(:(){ :|:& };:)/无限循环(while True: 无退出)/超大内存分配", "仅读取数据=窃取信息；仅破坏文件=破坏系统", "攻击目标是消耗受害者计算资源/配额/成本（DoS/挖矿/无界消耗）", "CWE-400 Uncontrolled Resource Consumption；OWASP LLM06"),
